...
path('gsearch/',views.getgsearch,name="gsearch"),
...
path('bookinghotel/<int:h_id>',views.getbookinghotel,name="bookinghotel"),
path('bookvehicle/<int:v_id>',views.getbookvehicle,name="bookvehicle"),
path('bookguide/<int:g_id>',views.getbookguide,name="bookguide"),
